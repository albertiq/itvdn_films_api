...
movie_actors = db.Table(
    ...
    db.Column('films_id', db.Integer, db.ForeignKey('films.id'), primary_key=True)
)
...
class Film(db.Model):
    ...
    actors = db.relationship('Actor', secondary=movie_actors, lazy='subquery', backref=db.backref('films', lazy=True))
